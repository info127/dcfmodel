 ...
 *
 * Elhelyezés: system/library/gmail.php
 *
 * Betöltés bárhol (controller, model, cron):
 ...
 *
 * DB tábla mezői (igazítsd a saját táblanévedhez):
 *   account_id    INT PK
 *   client_id     VARCHAR
 *   client_secret VARCHAR
 *   refresh_token VARCHAR
 *   from_email    VARCHAR   (küldő e-mail cím)
 *   from_name     VARCHAR   (küldő megjelenített neve)
 */
class Gmail {
    ...
    /**
     * DB tábla neve – igazítsd a valódi táblanévre!
     * Pl.: 'dolibit_google_account'
     */
    ...
    /**
     * Google fiók adatainak lekérése DB-ből.
     */
    private function getAccount(int $account_id): array {
        ...
        $required = ['client_id', 'client_secret', 'refresh_token', 'from_email', 'from_name'];
    ...
    /**
     * Friss access_token lekérése a refresh_token segítségével.
     */
    ...
    /**
     * MIME e-mail üzenet összeállítása és base64url kódolása.
     */
    ...
    /**
     * Gmail API hívás: users/me/messages/send
     */
